...
const createPaymentMethod = async (req, res) => {
  try {
    ...
    if (error) {
      logger.error(`Error creating payment method - paymentMethodModel: ${error.message}`);
      return res.status(400).send({
        result: null,
    ...
    logger.error(`Error creating payment method - paymentMethodController: ${err.message}`);
    res.status(500).send({
      result: null,
...
const getPaymentMethod = async (req, res) => {  
  try {
    ...
    if (error) {
      logger.error(`Error fetching payment method - paymentMethodModel: ${error.message}`);
      return res.status(400).send({
        result: null,
    ...
    logger.error(`Error fetching payment method - paymentMethodController: ${err.message}`);
    res.status(500).send({
      result: null,
...
const getAllPaymentMethods = async (req, res) => {  
  try {
    ...
    if (error) {
      logger.error(`Error fetching payment methods - paymentMethodModel: ${error.message}`);
      return res.status(400).send({
        result: null,
    ...
    logger.error(`Error fetching payment methods - paymentMethodController: ${err.message}`);
    res.status(500).send({
      result: null,
